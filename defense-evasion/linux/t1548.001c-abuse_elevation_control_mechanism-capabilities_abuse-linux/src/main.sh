...
function Get-Configuration {
    ...
    export T1548_001C_DEBUG_MODE="${T1548_001C_DEBUG_MODE:-false}"
    export T1548_001C_TIMEOUT="${T1548_001C_TIMEOUT:-300}"
    export T1548_001C_FALLBACK_MODE="${T1548_001C_FALLBACK_MODE:-real}"
    export T1548_001C_OUTPUT_FORMAT="${T1548_001C_OUTPUT_FORMAT:-json}"
    export T1548_001C_POLICY_CHECK="${T1548_001C_POLICY_CHECK:-true}"
    export T1548_001C_OBFUSCATION_LEVEL="${T1548_001C_OBFUSCATION_LEVEL:-basic}"
    export T1548_001C_ENCODING_METHOD="${T1548_001C_ENCODING_METHOD:-base64}"
    export T1548_001C_CLEANUP_FILES="${T1548_001C_CLEANUP_FILES:-true}"
    export T1548_001C_STEALTH_MODE="${T1548_001C_STEALTH_MODE:-false}"
    export T1548_001C_BACKGROUND_MODE="${T1548_001C_BACKGROUND_MODE:-true}"
