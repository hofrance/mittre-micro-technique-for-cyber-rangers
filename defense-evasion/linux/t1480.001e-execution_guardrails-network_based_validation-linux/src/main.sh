...
function Get-Configuration {
    ...
    export T1480_001E_DEBUG_MODE="${T1480_001E_DEBUG_MODE:-false}"
    export T1480_001E_TIMEOUT="${T1480_001E_TIMEOUT:-300}"
    export T1480_001E_FALLBACK_MODE="${T1480_001E_FALLBACK_MODE:-real}"
    export T1480_001E_OUTPUT_FORMAT="${T1480_001E_OUTPUT_FORMAT:-json}"
    export T1480_001E_POLICY_CHECK="${T1480_001E_POLICY_CHECK:-true}"
    export T1480_001E_OBFUSCATION_LEVEL="${T1480_001E_OBFUSCATION_LEVEL:-basic}"
    export T1480_001E_ENCODING_METHOD="${T1480_001E_ENCODING_METHOD:-base64}"
    export T1480_001E_CLEANUP_FILES="${T1480_001E_CLEANUP_FILES:-true}"
    export T1480_001E_STEALTH_MODE="${T1480_001E_STEALTH_MODE:-false}"
    export T1480_001E_BACKGROUND_MODE="${T1480_001E_BACKGROUND_MODE:-true}"
