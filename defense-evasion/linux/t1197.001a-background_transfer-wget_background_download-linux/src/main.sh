...
function Get-Configuration {
    ...
    export T1197_001A_DEBUG_MODE="${T1197_001A_DEBUG_MODE:-false}"
    export T1197_001A_TIMEOUT="${T1197_001A_TIMEOUT:-300}"
    export T1197_001A_FALLBACK_MODE="${T1197_001A_FALLBACK_MODE:-real}"
    export T1197_001A_OUTPUT_FORMAT="${T1197_001A_OUTPUT_FORMAT:-json}"
    export T1197_001A_POLICY_CHECK="${T1197_001A_POLICY_CHECK:-true}"
    export T1197_001A_OBFUSCATION_LEVEL="${T1197_001A_OBFUSCATION_LEVEL:-basic}"
    export T1197_001A_ENCODING_METHOD="${T1197_001A_ENCODING_METHOD:-base64}"
    export T1197_001A_CLEANUP_FILES="${T1197_001A_CLEANUP_FILES:-true}"
    export T1197_001A_STEALTH_MODE="${T1197_001A_STEALTH_MODE:-false}"
    export T1197_001A_BACKGROUND_MODE="${T1197_001A_BACKGROUND_MODE:-true}"
