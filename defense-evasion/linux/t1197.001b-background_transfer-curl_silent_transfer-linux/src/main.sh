...
function Get-Configuration {
    ...
    export T1197_001B_DEBUG_MODE="${T1197_001B_DEBUG_MODE:-false}"
    export T1197_001B_TIMEOUT="${T1197_001B_TIMEOUT:-300}"
    export T1197_001B_FALLBACK_MODE="${T1197_001B_FALLBACK_MODE:-real}"
    export T1197_001B_OUTPUT_FORMAT="${T1197_001B_OUTPUT_FORMAT:-json}"
    export T1197_001B_POLICY_CHECK="${T1197_001B_POLICY_CHECK:-true}"
    export T1197_001B_OBFUSCATION_LEVEL="${T1197_001B_OBFUSCATION_LEVEL:-basic}"
    export T1197_001B_ENCODING_METHOD="${T1197_001B_ENCODING_METHOD:-base64}"
    export T1197_001B_CLEANUP_FILES="${T1197_001B_CLEANUP_FILES:-true}"
    export T1197_001B_STEALTH_MODE="${T1197_001B_STEALTH_MODE:-false}"
    export T1197_001B_BACKGROUND_MODE="${T1197_001B_BACKGROUND_MODE:-true}"
