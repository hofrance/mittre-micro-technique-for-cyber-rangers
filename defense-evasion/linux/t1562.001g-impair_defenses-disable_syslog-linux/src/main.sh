...
function Get-Configuration {
    ...
    export T1562_001G_DEBUG_MODE="${T1562_001G_DEBUG_MODE:-false}"
    export T1562_001G_TIMEOUT="${T1562_001G_TIMEOUT:-300}"
    export T1562_001G_FALLBACK_MODE="${T1562_001G_FALLBACK_MODE:-real}"
    export T1562_001G_OUTPUT_FORMAT="${T1562_001G_OUTPUT_FORMAT:-json}"
    export T1562_001G_POLICY_CHECK="${T1562_001G_POLICY_CHECK:-true}"
    export T1562_001G_OBFUSCATION_LEVEL="${T1562_001G_OBFUSCATION_LEVEL:-basic}"
    export T1562_001G_ENCODING_METHOD="${T1562_001G_ENCODING_METHOD:-base64}"
    export T1562_001G_CLEANUP_FILES="${T1562_001G_CLEANUP_FILES:-true}"
    export T1562_001G_STEALTH_MODE="${T1562_001G_STEALTH_MODE:-false}"
    export T1562_001G_BACKGROUND_MODE="${T1562_001G_BACKGROUND_MODE:-true}"
