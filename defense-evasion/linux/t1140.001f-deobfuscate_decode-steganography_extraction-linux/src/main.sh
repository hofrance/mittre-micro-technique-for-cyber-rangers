...
function Get-Configuration {
    ...
    export T1140_001F_DEBUG_MODE="${T1140_001F_DEBUG_MODE:-false}"
    export T1140_001F_TIMEOUT="${T1140_001F_TIMEOUT:-300}"
    export T1140_001F_FALLBACK_MODE="${T1140_001F_FALLBACK_MODE:-real}"
    export T1140_001F_OUTPUT_FORMAT="${T1140_001F_OUTPUT_FORMAT:-json}"
    export T1140_001F_POLICY_CHECK="${T1140_001F_POLICY_CHECK:-true}"
    export T1140_001F_OBFUSCATION_LEVEL="${T1140_001F_OBFUSCATION_LEVEL:-basic}"
    export T1140_001F_ENCODING_METHOD="${T1140_001F_ENCODING_METHOD:-base64}"
    export T1140_001F_CLEANUP_FILES="${T1140_001F_CLEANUP_FILES:-true}"
    export T1140_001F_STEALTH_MODE="${T1140_001F_STEALTH_MODE:-false}"
    export T1140_001F_BACKGROUND_MODE="${T1140_001F_BACKGROUND_MODE:-true}"
