...
**File and Directory Discovery** - Découverte de fichiers et répertoires
...
- 🔥 **Variables atomiques** : Pattern TT1083_001a_CATEGORY_PARAMETER
...
export TT1083_001a_DEBUG_MODE="true"
export TT1083_001a_OUTPUT_MODE="debug"
export TT1083_001a_AUDIT_LOGGING="true"
./src/main.sh

# EXÉCUTION STEALTH POUR TESTS DE RECONNAISSANCE
export TT1083_001a_OUTPUT_MODE="stealth"
./src/main.sh
```
...
- `TT1083_001a_SIMULATION_MODE`: Mode simulation (toujours false pour vraies attaques)
- `TT1083_001a_SAFETY_CHECKS`: Vérifications sécurité (toujours false)
- `TT1083_001a_REQUIRE_CONFIRMATION`: Confirmation utilisateur (toujours false)
- `TT1083_001a_BACKUP_ORIGINAL`: Backup automatique (toujours false)
- `TT1083_001a_AUTO_ROLLBACK`: Rollback automatique (toujours false)

### Configuration de Base
- `TT1083_001a_DEBUG_MODE`: Mode debug (défaut: false)
- `TT1083_001a_OUTPUT_MODE`: Mode sortie (simple/debug/stealth)
- `TT1083_001a_VERBOSE_LEVEL`: Niveau verbosité (0-3)
- `TT1083_001a_AUDIT_LOGGING`: Audit logging (défaut: true)
...
- **Action** : File and Directory Discovery exécutée réellement
...
**T1083.001a = File and Directory Discovery = Vraie collecte d'intelligence = Entraînement d'élite**
