...
**Software Discovery** - Découverte des logiciels installés
...
- 🔥 **Variables atomiques** : Pattern TT1057_002a_CATEGORY_PARAMETER
...
export TT1057_002a_DEBUG_MODE="true"
export TT1057_002a_OUTPUT_MODE="debug"
export TT1057_002a_AUDIT_LOGGING="true"
./src/main.sh

# EXÉCUTION STEALTH POUR TESTS DE RECONNAISSANCE
export TT1057_002a_OUTPUT_MODE="stealth"
./src/main.sh
```
...
- `TT1057_002a_SIMULATION_MODE`: Mode simulation (toujours false pour vraies attaques)
- `TT1057_002a_SAFETY_CHECKS`: Vérifications sécurité (toujours false)
- `TT1057_002a_REQUIRE_CONFIRMATION`: Confirmation utilisateur (toujours false)
- `TT1057_002a_BACKUP_ORIGINAL`: Backup automatique (toujours false)
- `TT1057_002a_AUTO_ROLLBACK`: Rollback automatique (toujours false)

### Configuration de Base
- `TT1057_002a_DEBUG_MODE`: Mode debug (défaut: false)
- `TT1057_002a_OUTPUT_MODE`: Mode sortie (simple/debug/stealth)
- `TT1057_002a_VERBOSE_LEVEL`: Niveau verbosité (0-3)
- `TT1057_002a_AUDIT_LOGGING`: Audit logging (défaut: true)
...
- **Action** : Software Discovery exécutée réellement
...
### Commandes d'Attaque
```bash
dpkg -l 2>/dev/null || rpm -qa 2>/dev/null || ls /usr/bin | head -20
```
...
**T1057.002a = Software Discovery = Vraie collecte d'intelligence = Entraînement d'élite**
