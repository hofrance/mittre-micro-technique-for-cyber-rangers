...
**Password Policy Discovery** - Découverte de la politique de mots de passe
...
- 🔥 **Variables atomiques** : Pattern TT1057_005a_CATEGORY_PARAMETER
...
export TT1057_005a_DEBUG_MODE="true"
export TT1057_005a_OUTPUT_MODE="debug"
export TT1057_005a_AUDIT_LOGGING="true"
./src/main.sh

# EXÉCUTION STEALTH POUR TESTS DE RECONNAISSANCE
export TT1057_005a_OUTPUT_MODE="stealth"
./src/main.sh
```
...
- `TT1057_005a_SIMULATION_MODE`: Mode simulation (toujours false pour vraies attaques)
- `TT1057_005a_SAFETY_CHECKS`: Vérifications sécurité (toujours false)
- `TT1057_005a_REQUIRE_CONFIRMATION`: Confirmation utilisateur (toujours false)
- `TT1057_005a_BACKUP_ORIGINAL`: Backup automatique (toujours false)
- `TT1057_005a_AUTO_ROLLBACK`: Rollback automatique (toujours false)

### Configuration de Base
- `TT1057_005a_DEBUG_MODE`: Mode debug (défaut: false)
- `TT1057_005a_OUTPUT_MODE`: Mode sortie (simple/debug/stealth)
- `TT1057_005a_VERBOSE_LEVEL`: Niveau verbosité (0-3)
- `TT1057_005a_AUDIT_LOGGING`: Audit logging (défaut: true)
...
- **Action** : Password Policy Discovery exécutée réellement
...
### Commandes d'Attaque
```bash
chage -l root 2>/dev/null || cat /etc/login.defs 2>/dev/null | grep -E 'PASS|MINLEN'
```
...
**T1057.005a = Password Policy Discovery = Vraie collecte d'intelligence = Entraînement d'élite**
