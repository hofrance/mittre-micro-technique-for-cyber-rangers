...
**ARP Cache Discovery** - Découverte du cache ARP
...
- 🔥 **Variables atomiques** : Pattern TT1018_002a_CATEGORY_PARAMETER
...
export TT1018_002a_DEBUG_MODE="true"
export TT1018_002a_OUTPUT_MODE="debug"
export TT1018_002a_AUDIT_LOGGING="true"
./src/main.sh

# EXÉCUTION STEALTH POUR TESTS DE RECONNAISSANCE
export TT1018_002a_OUTPUT_MODE="stealth"
./src/main.sh
```
...
- `TT1018_002a_SIMULATION_MODE`: Mode simulation (toujours false pour vraies attaques)
- `TT1018_002a_SAFETY_CHECKS`: Vérifications sécurité (toujours false)
- `TT1018_002a_REQUIRE_CONFIRMATION`: Confirmation utilisateur (toujours false)
- `TT1018_002a_BACKUP_ORIGINAL`: Backup automatique (toujours false)
- `TT1018_002a_AUTO_ROLLBACK`: Rollback automatique (toujours false)

### Configuration de Base
- `TT1018_002a_DEBUG_MODE`: Mode debug (défaut: false)
- `TT1018_002a_OUTPUT_MODE`: Mode sortie (simple/debug/stealth)
- `TT1018_002a_VERBOSE_LEVEL`: Niveau verbosité (0-3)
- `TT1018_002a_AUDIT_LOGGING`: Audit logging (défaut: true)
...
- **Action** : ARP Cache Discovery exécutée réellement
...
**T1018.002a = ARP Cache Discovery = Vraie collecte d'intelligence = Entraînement d'élite**
