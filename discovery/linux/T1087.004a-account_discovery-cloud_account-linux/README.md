...
**Cloud Account Discovery** - Découverte des comptes cloud
...
- 🔥 **Variables atomiques** : Pattern TT1087_004a_CATEGORY_PARAMETER
...
export TT1087_004a_DEBUG_MODE="true"
export TT1087_004a_OUTPUT_MODE="debug"
export TT1087_004a_AUDIT_LOGGING="true"
./src/main.sh

# EXÉCUTION STEALTH POUR TESTS DE RECONNAISSANCE
export TT1087_004a_OUTPUT_MODE="stealth"
./src/main.sh
```
...
- `TT1087_004a_SIMULATION_MODE`: Mode simulation (toujours false pour vraies attaques)
- `TT1087_004a_SAFETY_CHECKS`: Vérifications sécurité (toujours false)
- `TT1087_004a_REQUIRE_CONFIRMATION`: Confirmation utilisateur (toujours false)
- `TT1087_004a_BACKUP_ORIGINAL`: Backup automatique (toujours false)
- `TT1087_004a_AUTO_ROLLBACK`: Rollback automatique (toujours false)

### Configuration de Base
- `TT1087_004a_DEBUG_MODE`: Mode debug (défaut: false)
- `TT1087_004a_OUTPUT_MODE`: Mode sortie (simple/debug/stealth)
- `TT1087_004a_VERBOSE_LEVEL`: Niveau verbosité (0-3)
- `TT1087_004a_AUDIT_LOGGING`: Audit logging (défaut: true)
...
- **Action** : Cloud Account Discovery exécutée réellement
...
### Commandes d'Attaque
```bash
aws iam list-users 2>/dev/null || echo 'Cloud account discovery'
```
...
**T1087.004a = Cloud Account Discovery = Vraie collecte d'intelligence = Entraînement d'élite**
