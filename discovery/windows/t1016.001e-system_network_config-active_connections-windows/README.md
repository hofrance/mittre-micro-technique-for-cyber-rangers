# T1016.001E - System Network Configuration Discovery

## Description
This package implements MITRE ATT&CK atomic micro-technique T1016.001E for Windows environments. System Network Configuration Discovery - Active Connections.
...
## Atomic Action
**Single Observable Action**: System Network Configuration Discovery - Active Connections ONLY
...
## Output Files
- `t1016.001e_results.json`: Execution results with metadata
- `t1016.001e_security_audit.log`: Security audit log
...
- `Get-NetTCPConnection` - Active TCP connections enumeration
- `Get-NetUDPEndpoint` - UDP endpoints enumeration
- `netstat` - Network statistics (fallback)
- `Win32_Process` - WMI process information for connection mapping
- `Win32_NetworkConnection` - WMI network connection details
