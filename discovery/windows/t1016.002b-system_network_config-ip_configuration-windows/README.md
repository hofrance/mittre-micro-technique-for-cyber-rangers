# T1016.002B - System Network Configuration Discovery

## Description
This package implements MITRE ATT&CK atomic micro-technique T1016.002B for Windows environments. System Network Configuration Discovery - IP Configuration.
...
## Atomic Action
**Single Observable Action**: System Network Configuration Discovery - IP Configuration ONLY
...
## Output Files
- `t1016.002b_results.json`: Execution results with metadata
- `t1016.002b_security_audit.log`: Security audit log
...
- `Get-NetIPConfiguration` - IP configuration details
- `Get-NetIPAddress` - IP address information
- `Get-NetIPInterface` - IP interface properties
- `Get-NetRoute` - Routing table information
- `Win32_NetworkAdapterConfiguration` - WMI IP configuration
