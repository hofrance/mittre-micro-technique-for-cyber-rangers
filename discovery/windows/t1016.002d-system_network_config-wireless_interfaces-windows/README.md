# T1016.002D - System Network Configuration Discovery

## Description
This package implements MITRE ATT&CK atomic micro-technique T1016.002D for Windows environments. System Network Configuration Discovery - Wireless Interfaces.
...
## Atomic Action
**Single Observable Action**: System Network Configuration Discovery - Wireless Interfaces ONLY
...
## Output Files
- `t1016.002d_results.json`: Execution results with metadata
- `t1016.002d_security_audit.log`: Security audit log
...
- `Get-NetAdapter` - Wireless adapter enumeration (filtering wireless)
- `Get-NetAdapterAdvancedProperty` - Advanced wireless adapter properties
- `netsh wlan show interfaces` - Wireless interface details
- `Win32_NetworkAdapter` - WMI wireless adapter information
- `Win32_WiFiNetworkAdapter` - WMI wireless-specific information
