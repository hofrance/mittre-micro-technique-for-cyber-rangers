# T1016.003A - System Network Configuration Discovery

## Description
This package implements MITRE ATT&CK atomic micro-technique T1016.003A for Windows environments. System Network Configuration Discovery - Listening Ports.
...
## Atomic Action
**Single Observable Action**: System Network Configuration Discovery - Listening Ports ONLY
...
## Output Files
- `t1016.003a_results.json`: Execution results with metadata
- `t1016.003a_security_audit.log`: Security audit log
...
- `Get-NetTCPConnection` - TCP listening ports enumeration
- `Get-NetUDPEndpoint` - UDP listening ports enumeration
- `netstat` - Network statistics (fallback)
- `Win32_Process` - WMI process information for port mapping
- `Win32_TCPIPPrinterPort` - WMI TCP/IP port information
