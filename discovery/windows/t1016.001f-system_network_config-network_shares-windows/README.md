# T1016.001F - System Network Configuration Discovery

## Description
This package implements MITRE ATT&CK atomic micro-technique T1016.001F for Windows environments. System Network Configuration Discovery - Network Shares.
...
## Atomic Action
**Single Observable Action**: System Network Configuration Discovery - Network Shares ONLY
...
## Output Files
- `t1016.001f_results.json`: Execution results with metadata
- `t1016.001f_security_audit.log`: Security audit log
...
- `Get-SmbOpenFile` - Open files on SMB shares
- `Get-SmbSession` - SMB session information
- `net view` - Network share discovery (fallback)
- `Win32_Share` - WMI share information
