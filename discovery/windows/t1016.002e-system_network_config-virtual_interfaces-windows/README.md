# T1016.002E - System Network Configuration Discovery

## Description
This package implements MITRE ATT&CK atomic micro-technique T1016.002E for Windows environments. System Network Configuration Discovery - Virtual Interfaces.
...
## Atomic Action
**Single Observable Action**: System Network Configuration Discovery - Virtual Interfaces ONLY
...
## Output Files
- `t1016.002e_results.json`: Execution results with metadata
- `t1016.002e_security_audit.log`: Security audit log
...
- `Get-NetAdapter` - Virtual adapter enumeration (filtering virtual)
- `Get-VMNetworkAdapter` - Hyper-V virtual network adapters
- `Get-NetAdapterBinding` - Virtual adapter binding information
- `Win32_NetworkAdapter` - WMI virtual adapter information
- `Win32_VirtualNetworkAdapter` - WMI virtual adapter details
