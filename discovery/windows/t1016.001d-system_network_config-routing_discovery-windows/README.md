# T1016.001D - System Network Configuration Discovery

## Description
This package implements MITRE ATT&CK atomic micro-technique T1016.001D for Windows environments. System Network Configuration Discovery - Routing Discovery.
...
## Atomic Action
**Single Observable Action**: System Network Configuration Discovery - Routing Discovery ONLY
...
## Output Files
- `t1016.001d_results.json`: Execution results with metadata
- `t1016.001d_security_audit.log`: Security audit log
...
- `Get-NetRoute` - Network routing table enumeration
- `Get-NetIPInterface` - IP interface information
- `Find-NetRoute` - Route discovery and analysis
- `Win32_IP4RouteTable` - WMI fallback for routing information
- `Win32_IP4PersistedRouteTable` - WMI fallback for persistent routes
